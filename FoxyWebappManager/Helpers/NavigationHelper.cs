...
{
    public static string GetNavigateTo(FrameworkElement item) => (string)item.GetValue(NavigateToProperty);

    public static void SetNavigateTo(FrameworkElement item, string value) => item.SetValue(NavigateToProperty, value);
